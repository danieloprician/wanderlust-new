...
export default function TestimonialSection({ testimonials }: TestimonialProps) {
  ...
  // Load testimonials from translations or use provided/default ones
  const displayTestimonials = testimonials || (t.raw('items') as Testimonial[]);
      ...
      <div className="container-custom">
        ...
        <div className="mt-12 text-center p-6 bg-surface rounded-xl max-w-md mx-auto">
          ...
          <p className="text-text-muted">
            {t('basedOn', { count: displayTestimonials.length })}
          </p>
        </div>
      </div>
    </section>
